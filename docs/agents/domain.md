...
- **`docs/agents/implementation/README.md`** — read this after the glossary/ADRs when you need to modify code. It points to implementation-specific docs for code maps, state, interactions, structures, and tests.
