...
describe("app shell", () => {
  ...
  it("renders array structure quick edit actions", () => {
    ...
    expect(markup).toContain('data-action="array-mode-array"');
    expect(markup).toContain('data-action="array-mode-stack"');
    expect(markup).toContain('data-action="array-mode-queue"');
    expect(markup).toContain('data-action="array-mode-deque"');
